...
/* harmony import */ var primeng_editor__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! primeng/editor */ "./node_modules/primeng/editor.js");
/* harmony import */ var primeng_editor__WEBPACK_IMPORTED_MODULE_35___default = /*#__PURE__*/__webpack_require__.n(primeng_editor__WEBPACK_IMPORTED_MODULE_35__);
...
/* harmony import */ var _ngx_progressbar_core__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! @ngx-progressbar/core */ "./node_modules/@ngx-progressbar/core/fesm5/ngx-progressbar-core.js");
/* harmony import */ var _services_admin_services_service__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./services/admin-services.service */ "./src/app/services/admin-services.service.ts");
/* harmony import */ var _kolkov_angular_editor__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! @kolkov/angular-editor */ "./node_modules/@kolkov/angular-editor/fesm5/kolkov-angular-editor.js");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_37__["ModalModule"],
                _ngx_progressbar_core__WEBPACK_IMPORTED_MODULE_40__["NgProgressModule"].forRoot(),
                ...
                _kolkov_angular_editor__WEBPACK_IMPORTED_MODULE_42__["AngularEditorModule"],
            ],
            providers: [
                _services_admin_services_service__WEBPACK_IMPORTED_MODULE_41__["AdminServicesService"],
        ...
        this.config = {
            ...
            aside: {
                ...
                items: [
                    ...
                    // 	submenu: [
                    // 		{
                    // 					title: 'Individual Feedbacks',
                    // 					page: '/feedback'
                    // 		}
                    // 		// {
                    // 		// 			title: 'Department Feedbacks',
                    // 		// 			page: '/material/navigation/menu'
                    // 		// }
                    // 	]
                    // },
...
var AsideLeftComponent = /** @class */ (function () {
    function AsideLeftComponent(el, classInitService, menuAsideService, layoutConfigService, router, layoutRefService, document, http, ref) {
        var _this = this;
        this.el = el;
        this.classInitService = classInitService;
    ...
    AsideLeftComponent.prototype.ngOnInit = function () {
        var _this = this;
        // Call Here for getting Customer Support
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostBinding"])('attr.mMenuAsideOffcanvas'),
    ...
    AsideLeftComponent = __decorate([
        ...
        __param(6, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_common__WEBPACK_IMPORTED_MODULE_9__["DOCUMENT"])),
...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(http, tokenStorage, util, router) {
        this.http = http;
...
var AdminServicesService = /** @class */ (function () {
    ...
    AdminServicesService.prototype.export = function () {
        return this.http.get('http://yea.jobesk.com/api/sample.csv');
    };
    AdminServicesService.prototype.changeColorAndLogo = function (body) {
        console.log(body);
        return this.http.post(this.baseUrl + 'color', body);
    };
    AdminServicesService.prototype.EmptyDatabase = function (id) {
        console.log(id);
        return this.http.delete(this.baseUrl + 'deletes?userId=' + id);
    };
    AdminServicesService.prototype.importSpeakercsv = function (file) {
        var formData = new FormData(); // Currently empty
        formData.append('speakercsv', file);
        console.log(file);
        return this.http.post(this.baseUrl + 'importSpeakerCSV', formData);
    };
    AdminServicesService.prototype.importcsv = function (file) {
        var formData = new FormData(); // Currently empty
        formData.append('file', file);
        console.log(file);
        return this.http.post(this.baseUrl + 'import', formData);
    };
    AdminServicesService.prototype.sponsorsImport = function (file) {
        var formData = new FormData(); // Currently empty
        formData.append('file', file);
        console.log(file);
        return this.http.post(this.baseUrl + 'sponsor-import', formData);
    };
    AdminServicesService.prototype.login = function (body) {
        console.log(body);
        return this.http.post(this.baseUrl + 'adminLogin', body);
    };
    AdminServicesService.prototype.ShowAllAttendies = function () {
        return this.http.get(this.baseUrl + 'attendees');
    };
    AdminServicesService.prototype.AddNewAdmin = function (data) {
        console.log(data);
        return this.http.post(this.baseUrl + 'generate_logins', data);
    };
    AdminServicesService.prototype.AddNewAttendee = function (data) {
        console.log(data);
        return this.http.post(this.baseUrl + 'generate_logins', data);
    };
    AdminServicesService.prototype.GetSingleAdminData = function (id) {
        return this.http.get(this.baseUrl + 'user/' + id);
    };
    AdminServicesService.prototype.PostSingleAdminData = function (data, id) {
        console.log(data);
        return this.http.post(this.baseUrl + 'updateUser/' + id, data);
    };
    AdminServicesService.prototype.GetSingleAttendeData = function (id) {
        return this.http.get(this.baseUrl + 'user/' + id);
    };
    AdminServicesService.prototype.deleteAttendee = function (id) {
        console.log(id);
        return this.http.delete(this.baseUrl + 'deleteUser/' + id);
    };
    AdminServicesService.prototype.PostSingleAttendeeData = function (data, id) {
        return this.http.post(this.baseUrl + 'updateUser/' + id, data);
    };
    AdminServicesService.prototype.ShowAllAdmins = function (id) {
        console.log(id);
        return this.http.get(this.baseUrl + 'showAdmins?userId=' + id);
    };
    AdminServicesService.prototype.ShowAllAttendiesPost = function () {
        return this.http.get(this.baseUrl + 'AllpostForADmin');
    };
    AdminServicesService.prototype.ShowAllAdminPost = function () {
        return this.http.get(this.baseUrl + 'AllpostForADmin');
    };
    AdminServicesService.prototype.GetAllSpeakers = function () {
        return this.http.get(this.baseUrl + 'speaker');
    };
    AdminServicesService.prototype.GetSingleSpeakerData = function (id) {
        return this.http.get(this.baseUrl + 'speaker/' + id);
    };
    AdminServicesService.prototype.AddNewSpeaker = function (data) {
        console.log(data);
        return this.http.post(this.baseUrl + 'speaker', data);
    };
    AdminServicesService.prototype.GetAllSponsors = function () {
        return this.http.get(this.baseUrl + 'sponsor');
    };
    AdminServicesService.prototype.GetAllAgenda = function () {
        return this.http.get(this.baseUrl + 'session');
    };
    AdminServicesService.prototype.GetSingleAgendaData = function (id) {
        return this.http.get(this.baseUrl + 'session/' + id);
    };
    AdminServicesService.prototype.deleteSpeaker = function (id) {
        return this.http.delete(this.baseUrl + 'speaker/' + id);
    };
    AdminServicesService.prototype.EditSpeaker = function (body, id) {
        console.log(id);
        return this.http.post(this.baseUrl + 'speaker/' + id, body);
    };
    AdminServicesService.prototype.GetSingleSponsorData = function (id) {
        return this.http.get(this.baseUrl + 'sponsor/' + id);
    };
    AdminServicesService.prototype.AddNewSponsor = function (body) {
        return this.http.post(this.baseUrl + 'sponsor', body);
    };
    AdminServicesService.prototype.deleteSponsor = function (id) {
        console.log(id);
        return this.http.delete(this.baseUrl + 'sponsor/' + id);
    };
    AdminServicesService.prototype.PostSingleSponsor = function (body, id) {
        console.log(id);
        return this.http.post(this.baseUrl + 'sponsor/' + id, body);
    };
    AdminServicesService.prototype.AddNewSession = function (body) {
        console.log(body);
        return this.http.post(this.baseUrl + 'addSession', body);
        // return this.http.post(this.baseUrl + 'addSession' , data , body);
    };
    AdminServicesService.prototype.EditSession = function (body, id) {
        console.log(body);
        return this.http.post(this.baseUrl + 'editSession/' + id, body);
        // return this.http.post(this.baseUrl + 'addSession' , data , body);
    };
    //   AddNewSession(data, body) {
    // // 	console.log(data);
    // // 	console.log(body);
    // // 	const da = {
    // // 		// data,
    ...
    //     // return this.http.post(this.baseUrl + 'addSession' , data , body);
    //   }
    AdminServicesService.prototype.deleteAgendaaa = function (id) {
        return this.http.delete(this.baseUrl + 'destroysessionData/' + id);
    };
    AdminServicesService.prototype.deleteAgenda = function (id) {
        console.log(id);
        return this.http.post(this.baseUrl + 'destroysessionData/', id);
    };
    AdminServicesService.prototype.deleteUserPost = function (id) {
        return this.http.delete(this.baseUrl + 'post/' + id);
    };
    AdminServicesService.prototype.ShowComments = function (id) {
        return this.http.get(this.baseUrl + 'showcomment?postId=' + id);
    };
    AdminServicesService.prototype.ShowAttachments = function (id) {
        return this.http.get(this.baseUrl + 'showAttache?postId=' + id);
    };
    AdminServicesService.prototype.getPageDataByid = function (id) {
        return this.http.get(this.baseUrl + 'AllpostForADmin?page=' + id);
    };
    AdminServicesService.prototype.getLeaderBoardInfo = function () {
        return this.http.get(this.baseUrl + 'getinfo');
    };
    AdminServicesService.prototype.saveLeaderBoardInfo = function (payload) {
        return this.http.post(this.baseUrl + "info", payload);
    };
    AdminServicesService.prototype.deleteFile = function (id) {
        return this.http.delete(this.baseUrl + "destroyspeakerSessiondoc/" + id);
    };
    AdminServicesService.prototype.uploadSingleFile = function (payload) {
        return this.http.post(this.baseUrl + "addSessionDoc", payload);
    };
    AdminServicesService.prototype.getAppSettings = function () {
        return this.http.get(this.baseUrl + "getColor");
    };
    AdminServicesService.prototype.notifyUsers = function (payload) {
        return this.http.post(this.baseUrl + "notifyUsers", payload);
    };
    AdminServicesService.prototype.deleteAttendees = function (ids) {
        var payload = {
            ids: ids
        };
        return this.http.post(this.baseUrl + "deleteAttendees", payload);
    };
...
var environment = {
    production: false,
    baseUrl: 'http://yea.jobesk.com/backend/public/index.php/'
};
...
module.exports = __webpack_require__(/*! C:\Users\Jobesk-Echo\Desktop\YEA2\YEA\YeaAdmin\src\main.ts */"./src/main.ts");
